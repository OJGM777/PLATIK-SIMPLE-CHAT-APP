...
// TO SHOW IN THE CREATEGROUPCHAT COMPONENT AS A SELECTABLE OBJECT (TO ADD A NEW MEMBER TO A GROUP CHAT)
...
const UserComponent = ({
  ...
  // SETTER IS FOR ADDING THEM TO A GROUP CHAT AND FILTER ALL THE REPETITIVE OBJECTS
  const handleClick = () => {
